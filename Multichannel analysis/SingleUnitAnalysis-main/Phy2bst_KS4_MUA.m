        ...
        if exist([tank_path '\StreamSplitInfo_All.mat'])
            ...
            if exist([tank_path '\Sorting\' Sorter '\sorter_output\spike_times.npy'])
                ...
                if ~isempty(muanums)
                    ...
                    % SpikeShapes = readNPY([tank_path '\Sorting\' Sorter '\sorter_output\templates.npy']); % Spike shapes
                    % templateindexes = readNPY([tank_path '\Sorting\' Sorter '\sorter_output\templates_ind.npy']); % Spike shapes
